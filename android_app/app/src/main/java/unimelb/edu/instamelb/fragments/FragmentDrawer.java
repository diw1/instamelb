...
import unimelb.edu.instamelb.adapters.AdapterDrawer;
...
public class FragmentDrawer extends Fragment {
    ...
    public List<Information> getData() {
        ...
        int[] icons = {R.drawable.ic_ic_action_homeim, R.drawable.ic_ic_action_searchim, R.drawable.ic_ic_action_cameraim,
        R.drawable.ic_ic_action_dialogim, R.drawable.ic_ic_action_glassesim};
